  ...
  return (
    <div>
      ...
      <header className="bg-primary text-neutral">
        <div className="container mx-auto flex flex-col items-center px-4 py-20 lg:flex-row">
          <div className="mb-10 lg:mb-0 lg:w-1/2">
            <h1 className="mb-6 text-4xl font-bold sm:text-5xl">
              Découvrez l'Excellence de Bicor Vie !
            </h1>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-lg bg-white p-6 shadow-lg">
              ...
              <h3 className="mb-3 text-xl font-bold">Expertise éprouvée</h3>
              <p className="text-textGray">
                Avec deux décennies d'expérience, notre équipe de conseillers
                expérimentés vous guide avec des recommandations adaptées.
              </p>
            </div>
            ...
            <div className="rounded-lg bg-white p-6 shadow-lg">
                ...
                >
                  ...
                  <g id="SVGRepo_iconCarrier">
                    ...
                    <g display="none">
                      ...
                      <path
                        display="inline"
                        d="M20,21.569c-0.095,0-0.189-0.021-0.282-0.062L5.434,15.115C5.165,14.995,4.994,14.72,5,14.413 c0.006-0.303,0.191-0.578,0.46-0.683l14.286-5.681C19.828,8.017,19.913,8,20,8c0.086,0,0.172,0.017,0.254,0.049l14.285,5.679 c0.275,0.11,0.455,0.378,0.461,0.683c0.008,0.308-0.163,0.584-0.434,0.704L20.281,21.51C20.192,21.549,20.096,21.569,20,21.569 L20,21.569z M7.626,14.468l12.339,5.522l12.409-5.522L20,9.549L7.626,14.468z"
                      ></path>{" "}
                      <path
                        display="inline"
                        d="M5.434,20.49c-0.361-0.163-0.53-0.604-0.376-0.983c0.113-0.275,0.372-0.454,0.659-0.454 c0.097,0,0.191,0.021,0.282,0.062l13.967,6.249l14.037-6.249c0.092-0.042,0.186-0.062,0.283-0.062c0.286,0,0.544,0.177,0.656,0.454 c0.155,0.379-0.014,0.82-0.376,0.983L20,27.008L5.434,20.49z"
                      ></path>{" "}
                      <path
                        display="inline"
                        d="M5.434,25.48c-0.362-0.164-0.531-0.604-0.376-0.981c0.113-0.275,0.372-0.454,0.659-0.454 c0.097,0,0.191,0.021,0.282,0.061l13.967,6.25l14.037-6.25c0.09-0.039,0.186-0.061,0.283-0.061c0.286,0,0.544,0.179,0.656,0.454 c0.155,0.378-0.014,0.819-0.375,0.981L20,32L5.434,25.48z"
                      ></path>{" "}
                    </g>{" "}
                    <g display="none">
                      {" "}
                    ...
                    <g display="none">
                      ...
                      <path
                        display="inline"
                        d="M33.125,35H6.875c-0.519,0-0.938-0.42-0.938-0.938v-5.75c0-0.518,0.419-0.938,0.938-0.938 c0.518,0,0.937,0.421,0.937,0.938v4.813h24.375v-4.813c0-0.518,0.419-0.938,0.938-0.938c0.518,0,0.938,0.421,0.938,0.938v5.75 C34.063,34.58,33.643,35,33.125,35"
                      ></path>{" "}
                      <path
                        display="inline"
                        d="M20.042,29.249c-0.235,0-0.469-0.089-0.651-0.265l-7.535-7.277c-0.373-0.36-0.383-0.954-0.023-1.326 c0.358-0.372,0.954-0.384,1.325-0.023l6.884,6.649l6.884-6.649c0.372-0.36,0.968-0.349,1.324,0.023 c0.36,0.372,0.351,0.966-0.022,1.326l-7.534,7.277C20.512,29.16,20.277,29.249,20.042,29.249"
                      ></path>{" "}
                      <path
                        display="inline"
                        d="M20.042,29.249c-0.518,0-0.938-0.421-0.938-0.939V5.937C19.104,5.418,19.524,5,20.042,5 c0.519,0,0.938,0.418,0.938,0.937V28.31C20.979,28.828,20.561,29.249,20.042,29.249"
                      ></path>{" "}
                    </g>{" "}
                    <g display="none">
                      {" "}
                      <path
                        display="inline"
                        d="M33.732,10.556h-8.844c-0.043-1.488-1.26-2.686-2.758-2.686H6.267C4.741,7.87,3.5,9.11,3.5,10.637v10.405 c0,1.527,1.241,2.768,2.767,2.768h1.292l4.637,5.353c0.156,0.181,0.382,0.282,0.619,0.282c0.094,0,0.19-0.016,0.287-0.051 c0.318-0.119,0.532-0.428,0.532-0.768V23.81h1.478c0.043,1.487,1.26,2.687,2.758,2.687h8.498v4.815c0,0.34,0.214,0.648,0.534,0.769 c0.095,0.034,0.19,0.05,0.284,0.05c0.236,0,0.463-0.102,0.619-0.281l4.637-5.353h1.291c1.526,0,2.768-1.241,2.768-2.768V13.323 C36.5,11.796,35.259,10.556,33.732,10.556z M15.102,13.323v8.848h-2.288c-0.452,0-0.819,0.368-0.819,0.819v3.44l-3.443-3.978 c-0.157-0.178-0.382-0.282-0.646-0.282c0,0-1.638,0-1.638,0c-0.623,0-1.129-0.505-1.129-1.129V10.637 c0-0.622,0.507-1.13,1.129-1.13h15.864c0.594,0,1.068,0.466,1.111,1.049h-5.374C16.343,10.556,15.102,11.796,15.102,13.323z M34.862,23.729c0,0.623-0.507,1.129-1.13,1.129h-1.664c-0.236,0-0.463,0.102-0.621,0.282l-3.442,3.977v-3.44 c0-0.451-0.368-0.818-0.819-0.818h-9.317c-0.622,0-1.128-0.506-1.128-1.129V13.323c0-0.623,0.506-1.13,1.128-1.13h15.864 c0.623,0,1.13,0.507,1.13,1.13V23.729z"
                      ></path>{" "}
                      <path
                        display="inline"
                        d="M32.841,14.703h-14.08c-0.452,0-0.819,0.367-0.819,0.818s0.367,0.819,0.819,0.819h14.08 c0.452,0,0.82-0.368,0.82-0.819S33.293,14.703,32.841,14.703z"
                      ></path>{" "}
                      <path
                        display="inline"
                        d="M32.841,17.706h-14.08c-0.452,0-0.819,0.367-0.819,0.819c0,0.451,0.367,0.819,0.819,0.819h14.08 c0.452,0,0.82-0.368,0.82-0.819C33.661,18.073,33.293,17.706,32.841,17.706z"
                      ></path>{" "}
                      <path
                        display="inline"
                        d="M25.426,20.71h-6.665c-0.452,0-0.819,0.367-0.819,0.818s0.367,0.819,0.819,0.819h6.665 c0.451,0,0.818-0.368,0.818-0.819S25.877,20.71,25.426,20.71z"
                      ></path>{" "}
                    </g>{" "}
                    <g display="none">
                      {" "}
                    ...
                    <g>
                      ...
                      <g>
                        ...
                        <g>
                          {" "}
                          <path d="M22.746,33.588h-5.538c-0.505,0-0.912-0.409-0.912-0.914c0-0.504,0.407-0.911,0.912-0.911h5.538 c0.504,0,0.911,0.407,0.911,0.911C23.657,33.179,23.25,33.588,22.746,33.588L22.746,33.588z"></path>{" "}
                        </g>{" "}
                        <g>
                          {" "}
                          <path d="M21.362,36h-2.769c-0.505,0-0.914-0.409-0.914-0.912c0-0.504,0.409-0.914,0.914-0.914h2.769 c0.502,0,0.912,0.41,0.912,0.914C22.274,35.591,21.864,36,21.362,36L21.362,36z"></path>{" "}
                        </g>{" "}
                      </g>{" "}
                      <g>
                        {" "}
                        <path d="M34.592,20.415h-3.648c-0.504,0-0.914-0.407-0.914-0.912c0-0.504,0.41-0.912,0.914-0.912h3.648 c0.504,0,0.911,0.408,0.911,0.912C35.503,20.008,35.096,20.415,34.592,20.415L34.592,20.415z"></path>{" "}
                      </g>{" "}
                      <g>
                        {" "}
                        <path d="M9.057,20.415H5.408c-0.504,0-0.911-0.407-0.911-0.912c0-0.504,0.407-0.912,0.911-0.912h3.648 c0.504,0,0.914,0.408,0.914,0.912C9.971,20.008,9.561,20.415,9.057,20.415L9.057,20.415z"></path>{" "}
                      </g>{" "}
                      <g>
                        {" "}
                        <path d="M20,9.474c-0.505,0-0.914-0.407-0.914-0.912V4.912C19.086,4.409,19.495,4,20,4s0.912,0.409,0.912,0.912v3.649 C20.912,9.066,20.505,9.474,20,9.474L20,9.474z"></path>{" "}
                      </g>{" "}
                      <g>
                        {" "}
                        <path d="M30.314,30.733c-0.232,0-0.465-0.089-0.644-0.268l-2.579-2.58c-0.356-0.355-0.356-0.934,0-1.291 c0.357-0.356,0.934-0.354,1.29,0.002l2.579,2.579c0.357,0.357,0.357,0.936,0,1.292C30.782,30.646,30.55,30.733,30.314,30.733 L30.314,30.733z"></path>{" "}
                      </g>{" "}
                      <g>
                        {" "}
                        <path d="M12.26,12.679c-0.232,0-0.466-0.089-0.646-0.268L9.037,9.833c-0.357-0.357-0.357-0.936,0-1.293 c0.357-0.356,0.934-0.356,1.29,0l2.579,2.579c0.357,0.356,0.357,0.936,0,1.292C12.728,12.59,12.495,12.679,12.26,12.679 L12.26,12.679z"></path>{" "}
                      </g>{" "}
                      <g>
                        {" "}
                        <path d="M9.682,30.733c-0.233,0-0.466-0.087-0.645-0.266c-0.357-0.356-0.357-0.935,0-1.292l2.581-2.581 c0.354-0.356,0.931-0.356,1.288,0c0.357,0.357,0.357,0.936,0,1.293l-2.579,2.58C10.148,30.645,9.916,30.733,9.682,30.733 L9.682,30.733z"></path>{" "}
                      </g>{" "}
                      <g>
                        {" "}
                        <path d="M27.738,12.679c-0.233,0-0.466-0.089-0.646-0.268c-0.354-0.356-0.354-0.934,0-1.29l2.579-2.579 c0.354-0.356,0.935-0.358,1.29-0.002c0.357,0.357,0.357,0.934,0,1.291l-2.577,2.578C28.206,12.588,27.973,12.679,27.738,12.679 L27.738,12.679z"></path>{" "}
                      </g>{" "}
                    </g>{" "}
                  </g>
                </svg>
              ...
              <p className="text-textGray">
                Chaque client est unique. Nous développons des plans d'assurance
                qui reflètent vos aspirations et vos objectifs.
              </p>
            </div>

            <div className="rounded-lg bg-white p-6 shadow-lg">
              <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-primary/10">
                <img src={heartSVG} alt="Icon" className="h-8 w-8" />
              </div>
              <h3 className="mb-3 text-xl font-bold">Accompagnement complet</h3>
              <p className="text-textGray">
                Que vous soyez à la tête d'une entreprise ou un salarié, nous
                vous offrons un soutien complet pour optimiser vos relations
                d'affaires.
              </p>
            </div>
      ...
      <section className="bg-primary py-20 text-neutral">
        <div className="container mx-auto px-4 text-center">
          <h2 className="mb-6 text-3xl font-bold">
            Ne laissez pas l'incertitude du futur vous freiner
          </h2>
